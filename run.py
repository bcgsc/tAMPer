...
def main():
    ...
    parser.add_argument('-ck', '--checkpoint_dir', default=os.getcwd(), type=str, required=False)
    parser.add_argument('-pck', '--pre_chkpnt', default="None", type=str, required=False)
    parser.add_argument('-log', '--log_file', default=os.getcwd(), type=str, required=False)
    parser.add_argument('-res', '--res', default=f'{os.getcwd()}/rez.csv', type=str, required=False)
    parser.add_argument('-name', '--name', default="", type=str, required=False)
    parser.add_argument('-wu', '--warmup', default=-1, type=int, required=False)
